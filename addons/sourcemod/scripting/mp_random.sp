...
public void OnPluginStart()
{
    ...
    g_sOfficialMapsM3.PushString("c7m1_docks");
    g_sOfficialMapsM3.PushString(NULL_MAP);
    ...
    g_sOfficialMapsM5.PushString("c7m3_port");
    g_sOfficialMapsM5.PushString(NULL_MAP);
    ...
    g_sOfficialMapsM5.PushString(NULL_MAP);
    g_sOfficialMapsM5.PushString("c14m2_lighthouse");
...
public void OnAllPluginsLoaded() {
	AddMixType("randmap", MIN_PLAYERS, 0);
}
...
public void GetVoteDisplayMessage(int iClient, char[] sTitle) {
	Format(sTitle, DISPLAY_MSG_SIZE, "开始随机MixMap", iClient);
}

public void GetVoteEndMessage(int iClient, char[] sMsg) {
	Format(sMsg, VOTEEND_MSG_SIZE, "即将切换至m1...", iClient);
}
